...
export default function Home() {
  return (
    ...
    >
      ...
      {/* Features Section */}
      <section className=" text-white py-12 px-6 bg-[rgba(255,255,255,0.2)]">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">
          Key Features
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-lg shadow-md hover:shadow-lg transition bg-[rgba(0,0,0,0.7)]" >
      ...
      <section className="bg-transparent text-white py-12 px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          <div className=" p-6 rounded-lg max-w-md shadow-md hover:shadow-lg transition bg-[rgba(0,0,0,0.7)]">
